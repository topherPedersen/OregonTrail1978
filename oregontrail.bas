...
2550 PRINT "TOUGHT---YOU NEED MORE BULLETS TO GO HUNTING"
2560 GOTO 2080
2570 M=M-45
2580 GOSUB 6140
...
4170 M=M-15
4180 GOTO 4710
4190 PRINT "LOSE YORU WAY IN HEAVY FOG---TIME IS LOST"
4200 M=M-10-5*RND(-1)
4210 GOTO 4710
...
4430 GOTO 4450
4440 PRINT "SLOW ON THE DRAW---THEY GOT AT YORU FOOD AND CLOTHES"
4450 B=B-20*B1
4460 C=C-B1*4
4470 F=F-B1*8
4480 GOTO 4710
...
6209 REM 'CLK(0)' FUNCTION CHANGED TO 'TIMER' BY C.D.P. FOR COMPATIBILITY
6210 B3 = TIMER
6220 INPUT C$
