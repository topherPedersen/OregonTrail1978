...
231 REM TODO: FIX TEXT-FORMATTING FOR THE TRS-80S 32 CHAR LIMIT
232 REM ***TRS-80 MAX CHAR WIDTH DISPLAYED BELOW ON LINE 233 ****
233 PRINT "12345678901234567890123456789012"
240 PRINT "THIS PROGRAM SIMULATES A TRIP"
241 PRINT "OVER THE OREGON TRAIL FROM"
242 PRINT "INDEPENDENCE, MISSOURI TO OREGON"
243 PRINT "CITY, OREGON IN 1847. YOUR"
244 PRINT "FAMILY OF FIVE WILL COVER THE"
245 PRINT "2040 MILE OREGON TRAIL IN 5-6"
246 PRINT " MONTHS--- IF YOU MAKE IT ALIVE."
280 PRINT
...
750 PRINT "MORE SUCCESS YOU WILL HAVE WITH YOUR GUN."
760 INPUT D9
...
6230 IF D9=1 THEN B1=B3+((RND(0)*1)+1)
6231 IF D9=2 THEN B1=B3+((RND(0)*2)+1)
6232 IF D9=3 THEN B1=B3+((RND(0)*3)+1)
6233 IF D9=4 THEN B1=B3+((RND(0)*4)+1)
6234 IF D9=5 THEN B1=B3+((RND(0)*5)+1)
